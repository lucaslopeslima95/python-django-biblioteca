...
class ClienteForm(ModelForm):
    ...
    cpf = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "Cpf","class": "form-control",'min':14,'max':14}))
    ...
    class Meta:
        model = Cliente
        fields = ['nome','email','cpf','data_nascimento','endereco','telefone']
